...
//     const [selectedProgram, setSelectedProgram] = useState('tiny_tots'); // Default to Tiny Tots
...
const App = () => {
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [selectedProgram]); // Fetch students when selected program changes
    ...
    const handleSaveEdit = () => {
        ...
        addStudentToDatabase(selectedProgram, updatedStudent); // Update Firebase
        setAlertMessage('Student details updated successfully');
        setShowAlert(true);
        setStudentToEdit(null); // Reset editing state
        setNewStudent({ name: '', class: '', phone: '' }); // Clear form
        ...
        <Router>
            <div className="max-w-4xl p-6 mx-auto">
                ...
                <Routes>
                    ...
                    />
                    <Route path="/dashboard/:selectedProgram" element={<Dashboard />} />
                    <Route
                        path="/"
                        element={
                            <>
