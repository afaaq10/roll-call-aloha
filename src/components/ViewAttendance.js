        ...
        <div className="p-6">
            ...
            {selectedStudent && (
                <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white rounded-lg p-6 max-w-lg md:w-full w-[23rem]">
                        <div className="flex justify-between items-center">
                            <h3 className="md:text-xl text-base font-semibold">{selectedStudent.name}</h3>
                            <button
                                onClick={closeModal}
                        ...
                        <div className="mt-4 max-h-60 overflow-y-auto">
                            {selectedStudent.attendance.length > 0 ? (
                                filterAttendanceByDate(selectedStudent.attendance).length > 0 ? (
                                    <ul>
                                        {filterAttendanceByDate(selectedStudent.attendance).map((record, index) => {
                                    ...
                                    <span className='text-red-800'>No attendance found for the selected date.</span>
                                )
                            ) : (
